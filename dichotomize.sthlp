...
{phang}{cmd:. sysuse webauto}{p_end}
{phang}{cmd:. dichotomize mpg, inlist(25/41) generate(mpg_hi) label("High milage")}{p_end}
{phang}{cmd:. dichotomize mpg, leq(25) gen(mpg_low) lab("Low milage")}{p_end}
{phang}{cmd:. dichotomize mpg, leq(25) geq(20) gen(mpg_mid) lab("Mid milage")}{p_end}
{phang}{cmd:. dichotomize mpg, leq(15) geq(35) gen(mpg_ext) lab("Too low-high milage")}{p_end}
{phang}{cmd:. dichotomize mpg, in(15 17) geq(35) leq(35) gen(mpg_cherry) lab("Cherry-picked milage") before(trunk)}{p_end}
